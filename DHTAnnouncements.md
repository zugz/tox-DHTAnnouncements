...
and stop searching at a timed hash for which the observer has the key may 
deduce information about our node time. This may also be done less efficiently 
by an observer who doesn't have the key, by comparing our search times with 
those of others searching/announcing at the same key.
